class Administrator::StaticPagesController < AdministratorController
  ...
  def index
    @static_pages = StaticPage.all.paginate(:page => params[:page], :per_page => 10)
  end
  ...
  def static_page_params
      params.require(:static_page).permit(:title, :content, :meta_title, :meta_description, :meta_keywords)
  end
